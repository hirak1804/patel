...
const Contact: FC = memo(() => {
  ...
  return (
    <Section className="bg-slate-800" sectionId={SectionId.Contact}>
                    ...
                    <dd className="flex items-center">
                      <a
                        className={classNames(
                          '-m-2 flex rounded-md p-2 text-neutral-300 hover:text-red-500 focus:outline-none focus:ring-2 focus:ring-red-500',
